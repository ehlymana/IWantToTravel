    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <div class="col-sm-2" style="float: right;text-align: right;padding: 0; font-size: 16pt;margin-top: -40px;">
                <button type="button" class="btn btn-link my-btn-link" data-toggle="modal" data-target="#addUserModal" style="font-size: 18pt;"><i class="fa fa-plus" style="font-size:16pt;color:green"></i> Add User</button>
            </div>
        </div>
        <div class="col-sm-12">
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <tr th:each="user: ${usersList}">
                        ...
                        <td><button type="button" class="btn btn-link my-btn-link" data-toggle="modal" th:attr="data-target='#editModal-' + ${user.getUserID()}">
                            <i class="fa fa-edit" style="font-size:16pt;color:#254A25;"></i>
                        </button> </td>
                        <td><a class="btn btn-link my-btn-link" th:href="@{'/deleteuser/' + ${user.getUserID()}}">
